...
/**
 * Full Morty config schema
 */
export const MortyConfigSchema = z.object({
...
export const RalphyConfigSchema = MortyConfigSchema;

/**
 * Morty configuration from .morty/config.yaml
 */
export type MortyConfig = z.infer<typeof MortyConfigSchema>;

// Alias for backward compatibility
export type RalphyConfig = MortyConfig;
